...
export default async (req, res) => {
  ...
  try {
    ...
    const query = `
      SELECT Courses.course_ID, Courses.name, Instructors.surname, Departments.name as department_name, Courses.credits, Courses.classroom_ID, Courses.time_slot, Courses.quota,
